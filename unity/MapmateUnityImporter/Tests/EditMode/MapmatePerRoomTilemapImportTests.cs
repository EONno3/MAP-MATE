...
namespace Mapmate.UnityImporter.Editor.Tests
{
  ...
  ""connections"": []
        ...
        [Test]
        public void PerRoom_When_ImportTilesDisabled_DoesNotPaintTiles()
        {
            var rootName = "MapmateTestRoot_PerRoom_NoTiles";
  ...
  ""connections"": []
            ...
            var tm1 = room1AutoTilemap.GetComponent<Tilemap>();
            Assert.IsNotNull(tm1);
            Assert.IsNull(tm1.GetTile(new Vector3Int(0, 0, 0)));
